...
default['rbpm']['postgres_password']="n"
default['rbpm']['postgres_port']="5432"
default['rbpm']['uad']="cn=UserApplication,cn=driverset1,o=system"
default['rbpm']['uaadmin']="cn=uaadmin,ou=sa,o=data"
default['rbpm']['groups']="ou=groups,o=data"
default['rbpm']['root']="o=data"
default['rbpm']['users']="o=data"
default['rbpm']['dbadmin']="idmadmin"
default['rbpm']['dbname']="idmuserappdb"
default['rbpm']['context']="IDMProv"
default['rbpm']['driverset']="cn=driverset1,o=system"
